    ...
    <>
      <main className=' h-full m-0 p-0 w-full'>
        ...
        <article className='w-full h-48 md:max-w-6xl md:mx-auto md:max-h-full md:h-full md:flex'>
          {/* cart Image */}
          <div className='block w-full m-0 md:h-full md:m-0'>
            <Image
          ...
          {/* cart Image */}
          {/* cart Info */}
          <div className='w-full mx-auto bg-mainLightColor md:w-1/2 md:min-h-full md:flex md:items-center'>
            <div className='w-10/12 mx-auto flex flex-col items-center justify-center'>
              ...
              <div className='text-center my-5 md:my-1'>
                <p className='font-light tracking-wide text-3xl text-mainColor'>
                  Freedom{' '}
                </p>
                <p className='font-light tracking-wide text-3xl text-mainColor'>
                  Security{' '}
